                    ...
                    <div class="card">
                        <div class="content">
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="number of rooms" data-sortable="true">Number of Rooms</th>
                                    ...
                                    @else
                                        @foreach($room_types as $index => $room_type)
                                            <tr>
                                               ...
                                               <td><span class="btn btn-default btn-xs">{{ $room_type->order }}</span></td>
                                               <td><span class="btn btn-default btn-xs">{{ $room_type->numberofrooms }}</span></td>
                                                <td>
