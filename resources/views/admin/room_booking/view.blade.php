                    ...
                    <div class="card">
                        <div class="content">
                            ...
                            <table id="bootstrap-table" class="table">
                                ...
                                <th data-field="arrival_date" class="text-center">Arrival Date</th>
                                <th data-field="departure_date" class="text-center">Departure Date</th>
                                ...
                                <tbody>
                                @unless(count($room_bookings))
                                    @else
                                        @foreach($room_bookings as $index => $room_booking)
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                <td>{{ $room_booking->room_type_names }}</td>
                                                <td>{{ $room_booking->firstName." ". $room_booking->lastName }}<br>
                                                    <strong>Email: </strong>{{ $room_booking->email }}
                                                </td>
                                                <td>
                                                    {{ $room_booking->arrival_date}}
                                                </td>
                                                <td>
                                                    {{ $room_booking->departure_date}}
                                                </td>
                                                <td>
