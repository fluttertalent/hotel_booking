                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            ...
                                            <option value="checked_in"
                                                    @if ($room_booking->status == 'checked_in') selected="selected" @endif>
                                                Checked In
                                            </option>
                                            <option value="checked_out"
                                                    @if ($room_booking->status == 'checked_out') selected="selected" @endif>
                                                Checked Out
                                            </option>
                                            <option value="cancelled"
                                                    @if ($room_booking->status == 'cancelled') selected="selected" @endif>
                                                Cancelled
                                            </option>
                                        </select>
                                    </div>
