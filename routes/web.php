...
Route::get('/roombook/{ids}/{arriaval_date}/{departure_date}', 'Front\RoomTypeController@showbook');
Route::post('/room_type_book/{ids}', 'Front\RoomBookingController@suiteBook');
...
Route::post('checkSuiteAvailability', 'Front\RoomTypeController@checkSuiteAvailability');
